...
for (vcp in c(-0.3,-0,2,0.01, 0.1)) {
  for (vmax_depth in c(2, 4, 8, 10, 24, 28)) {
    for (vmin_split in c(10000, 8000, 600, 400, 200, 150, 100, 90, 50, 10)) {
      for (vmin_bucket in c(100, 200, 300, 400, 500, vmin_split/4)) {
